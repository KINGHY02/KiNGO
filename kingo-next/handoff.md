...
4. 当前版本号已切换为 `2.0.4`；用户已在 2026-08-16 明确要求推送新版本。后续仍需以 GitHub Actions 和 Release 资产实际完成为发布成功依据。
...
5. `2.0.4` 已获得发布授权；推送后需确认 GitHub Actions、安装包、签名文件和自动更新元数据全部生成成功。
