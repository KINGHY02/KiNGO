...
| 首页 | Clash 模式 |
| --- | --- |
| ![KiNGO 首页](./docs/screenshots/home.png) | ![KiNGO Clash 模式](./docs/screenshots/clash.png) |

| V2rayN 模式 |
| --- |
| ![KiNGO V2rayN 模式](./docs/screenshots/v2rayn.png) |

## KiNGO 是什么？

KiNGO 是一款面向 Windows 的网络代理客户端，目标是让不同使用习惯的用户都能快速上手：
